<template>
    <div class="loading">
        <img src="@rs/loadingcircle.png" alt="">
        <div ref="logo" class="logo">
            <svg class="ares" width="260" height="260" viewBox="0 0 260 260" preserveAspectRatio="xMidYMid meet">
                <defs>
...
.loading
    ...
    background linear-gradient(to right, lighten(black, 10%), darken(palette(1), 40%))
    position fixed
    top 0
    z-index 3
    display flex
