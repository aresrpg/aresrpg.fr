...
export default {
	data() {
		return {
			datas: ['twitter', 'github', 'youtube', 'discord'],
		}
	},
	components: {
		twitter,
...
header
    animation lights 5s ease-light infinite alternate
    position relative
    z-index 9999
...
@keyframes lights
    from
        filter drop-shadow(0 0 .5em #0050ef)

    to
        filter drop-shadow(0 0 1em $red-light)
</style>
